...
HD_PWD='C:/Users/DELL/Desktop/multi_wrq/multi_wrq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys.vdi -applog -m64 -messageDb vivado.pb -mode batch -source basys.tcl -notrace
